...
<div id="navbar">
    ...
    <div class="content_wrapper">
        ...
        <div style="padding-top:100px;">
            <form action="../cLCookie.php" method="post">
                <table align="center"style="border-radius:30px;background: rgba(0, 255, 115, 0.651); padding:30px;">
                    ...
                    <tr align="center">
                        <td colspan="2"><br><a href="../seller/seller_login.php" style="text-decoration:none; font-weight:bolder;">Login as Seller</a></td>
                    </tr>
                    <tr align="center">
                        <td colspan="2"><br><a href="../admin_area/admin_login.php" style="text-decoration:none; font-weight:bolder;">Admin as Seller</a></td>
                    </tr>
                </table>
            </form>
        </div>
