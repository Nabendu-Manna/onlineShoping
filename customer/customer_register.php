        ...
        <div style="padding-top:100px;">
            <form action="registerDB.php" method="post" enctype="multipart/form-data">
                <table align="center"style="border-radius:30px;background: rgba(0, 255, 115, 0.651); padding:30px;">
                    ...
                    <tr>
                        <td align="right"><b>Customer Phone no</b></td>
                    ...
                    <tr>
                        <td align="right"><b>Customer pin</b></td>
                        <td align="left"><input type="text" name="c_pin" required/></td>
                    </tr>
                    <tr>
                        <td align="right"><b>Customer photo</b></td>
