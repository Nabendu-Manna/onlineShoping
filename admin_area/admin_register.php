            ...
            <form action="registerDB.php" method="post" enctype="multipart/form-data">
                <table align="center"style="border-radius:30px;background: rgba(0, 255, 115, 0.651); padding:30px;">
                    ...
                    <tr>
                        ...
                        <td align="left"><input type="text" name="a_name" required/></td>
                    </tr>
                    <tr>
                        <td align="right"><b> email</b></td>
                        <td align="left"><input type="text" name="a_email" required/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left"><input type="text" name="a_country" required/></td>
                    </tr>
                    <tr>
                        <td align="right"><b> City</b></td>
                        <td align="left"><input type="text" name="a_city" required/></td>
                    </tr>
                    <tr>
                        <td align="right"><b> Phone no</b></td>
                        <td align="left"><input type="text" name="a_contact" required/></td>
                    </tr>
                    <tr>
                        <td align="right"><b> Address</b></td>
                        <td align="left"><input type="text" name="a_address" required/></td>
                    </tr>
                    <tr>
                        <td align="right"><b> pin</b></td>
                        <td align="left"><input type="text" name="a_pin" required/></td>
                    </tr>
                    <tr>
                        <td align="right"><b> photo</b></td>
                        <td align="left"><input type="file" name="a_image" /></td>
                    </tr>
