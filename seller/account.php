            ...
            <div id="products_box">
                <?php
                    ...
                    while ($row_products = mysqli_fetch_array($run_customer)) {
                        $customer_id = $row_products['seller_id'];
                        $customer_name = $row_products['seller_name'];
                        $customer_email = $row_products['seller_email'];
                        $customer_pass = $row_products['seller_pass'];
                        $customer_address = $row_products['seller_address'];
                        $customer_image = $row_products['seller_image'];
                        echo "
                            <div id='single_product'>
                                <h3>$customer_name</h3>
                                <img src='seller_images/$customer_image'><br/>
                            </div>
                            <div id='single_product'>
