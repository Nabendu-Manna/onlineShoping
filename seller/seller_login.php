...
<div id="navbar">
    ...
    <div class="content_wrapper">
        ...
        <div style="padding-top:100px;">
            <form action="../sLCookie.php" method="post">
                <table align="center"style="border-radius:30px;background: rgba(0, 255, 115, 0.651); padding:30px;">
                    ...
                    <tr>
                        <td align="right">Enter your email: </td><td align="left"><input type="text" name="s_email" placeholder="Enter your email" required/></td>
                    </tr>
                    <tr>
                        <td align="right">Enter your passsword: </td><td align="left"><input type="password" name="s_pass" placeholder="Enter your passsword" required/></td>
                    </tr>
                    <tr><td colspan="2" align="center"><a href="forgot_pass.php" style="text-decoration:none;">Forgot passsword</a></td></tr>
                    <tr align="center">
                        <td colspan="2"><input type="submit" name="s_login" value="Login"/></td>
                    </tr>
                    <tr align="center">
                        <td colspan="2"><br><a href="seller_register.php" style="text-decoration:none; font-weight:bolder;">New register</a></td>
                    </tr>
                </table>
            </form>
        </div>
